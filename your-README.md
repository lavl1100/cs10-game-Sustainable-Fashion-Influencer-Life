...
Although the game was supposed to be more story-oriented, as stated in our design doc, we decided that it would be better to create a simulation/minigame-based game due to time constraints. The player enters the game already knowing the impact of promoting sustainable fashion on their platform, omitting the story which would 
